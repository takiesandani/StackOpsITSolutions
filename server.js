...
// =========================================================
// 1. CORE EXPRESS APP SETUP (FIXED: Moved to the top)
// =========================================================
const app = express();
app.use(express.json());
app.use(cors());

// NEW FIX: Middleware to serve static files (Home.html, CSS, JS, etc.)
...
// =========================================================
// 2. HTML PAGE ROUTES (Must be after app = express())
// =========================================================

// Root route for the Cloud Run startup probe and for serving your main page
app.get('/', (req, res) => {
    // Correctly serves Home.html as the main page
...
// Route to serve the Sign In page (required for the JWT middleware redirects)
...
// Route to serve the Password Reset page (must include token verification)
